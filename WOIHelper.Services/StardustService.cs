...
namespace WOIHelper.Services
{
    ...
    {
        private readonly List<Stardust> _stardusts = new List<Stardust>
        {
        ...
        public List<Requirement> GetRequirements(string stardustName)
        {
            ...
            {
                if (requirement.Name.ToLower().Contains("stardust") &&
                    !requirement.Name.ToLower().Equals("sealed stardust"))
                {
